...
class BreastfeedingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create breastfeeding" do
    assert_difference('Breastfeeding.count') do
      post breastfeedings_url, params: { breastfeeding: { baby_id: @breastfeeding.baby_id, feedtime: @breastfeeding.feedtime, volume: @breastfeeding.volume } }
    end
  ...
  test "should update breastfeeding" do
    patch breastfeeding_url(@breastfeeding), params: { breastfeeding: { baby_id: @breastfeeding.baby_id, feedtime: @breastfeeding.feedtime, volume: @breastfeeding.volume } }
